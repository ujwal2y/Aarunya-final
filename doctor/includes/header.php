...
<head>
    ...
    <title><?php echo $pageTitle ?? 'Doctor Portal'; ?> - Aarunya Doctor</title>
    <?php
    // Detect if we're in pages subfolder or root
    $isInPages = (basename(dirname($_SERVER['PHP_SELF'])) === 'pages');
    $cssPath = $isInPages ? '../assets/css/premium-design-system.css' : 'assets/css/premium-design-system.css';
    ?>
...
<body>
    <div class="app-layout">
        <?php include ($isInPages ? '../includes/sidebar.php' : 'includes/sidebar.php'); ?>
